...
class Gui(customtkinter.CTk):
    def __init__(self):
        ...
        self.Total_Contacts = customtkinter.CTkLabel(self.input_frame, text="Total Contacts In File: 0", text_color='#5e8a71', font=customtkinter.CTkFont(size=18, weight="bold"))
        ...
        self.new_contacts.grid(row=6, column=0, padx=20, pady=(2, 50), columnspan=2)

        self.version_label = customtkinter.CTkLabel(self.input_frame, text_color='#3474eb', text="Ver: 0.11    (28.11.2023)", anchor="ne")
        self.version_label.grid(row=7, column=0, padx=10, pady=(3, 3), columnspan=2)
    ...
    def thread_print(self):
        ...
        self.title_label.configure(text="In process")
        self.Total_Contacts.configure(text=f'Total Contacts In File: {contacts_file.read_contacts_file(filepath)}')
